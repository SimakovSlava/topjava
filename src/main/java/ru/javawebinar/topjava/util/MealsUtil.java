...
public class MealsUtil {
    public static void main(String[] args) throws InterruptedException {
        ...
        List<MealTo> mealsTo1 = filteredByStreams(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    public static List<MealTo> filteredByCycle(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        final Map <LocalDate, Integer> caloriesSumByDate  = new HashMap<>();
        meals.forEach(meal -> caloriesSumByDate.merge(meal.getDate(), meal.getCalories(), Integer::sum));

        final List<MealTo> mealTo = new ArrayList<>();
        meals.forEach(meal -> {
